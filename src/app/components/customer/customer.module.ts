...
import { CustomerAddFixedComponent } from "./add-charge/add-charge.component";
...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([
      ...
      {
        path:':afm/fixedfee/:chargeType',
        component:CustomerAddFixedComponent
      },
      {
        path: ':afm/files',
